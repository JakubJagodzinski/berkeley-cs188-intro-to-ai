...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    position = state[0]
    visited_corners = state[1]
    corners_to_visit = [index for index in range(len(visited_corners)) if visited_corners[index] == False]
    while corners_to_visit:
        nearest_corner_index = -1
        nearest_corner_distance = 9999999
        for index in corners_to_visit:
            ...
            if distance < nearest_corner_distance:
                ...
                nearest_corner_index = index
        position = corners[nearest_corner_index]
        corners_to_visit.remove(nearest_corner_index)
        distance += nearest_corner_distance
    return distance
